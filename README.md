...
You can see all the available endpoints & methods using the [Swagger UI]([https://location.chainxy.com/swagger/ui/index](https://location.chainxy.com/swagger/index.html) (/swagger/ui/index).
